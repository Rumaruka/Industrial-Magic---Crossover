...
public class KnowledgeEMT  {
    ...
    private static void $init()
    {
        ...
        new REB().setBaseInfo("EMT.ARMORS", "armor",-4 , 0, new ItemStack(EMTItems.quantumarmor)).setMeta(ResearchEntry.EnumResearchMeta.HIDDEN, ResearchEntry.EnumResearchMeta.HEX).setStages(new RSB().setText("research_stage." + emt.MOD_ID + ":armor.1").setKnow(new ResearchStage.Knowledge(IPlayerKnowledge.EnumKnowledgeType.OBSERVATION, ResearchCategories.getResearchCategory("ARTIFICE"), 1)).build(), new RSB().setText("research_stage." + emt.MOD_ID + ":armor.2").setRecipes("EMT.electricgoggles","EMT.nanoBOT","EMT.qBOT","EMT.qGOR","EMT.nanoGOR").build()).setParents("EMT.WINGS").buildAndRegister();
